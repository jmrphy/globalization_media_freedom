...
\hline
Intercept               & $0.28$        & $0.16$        & $0.30$       & $-1.62^{**}$ & $0.06$        & $-1.17$       \\
                        & $(0.18)$      & $(0.18)$      & $(0.75)$     & $(0.63)$     & $(0.77)$      & $(1.27)$      \\
Democracy$_{t-1}$       & $4.66^{***}$  & $4.66^{***}$  & $4.67^{***}$ & $5.44^{***}$ & $5.00^{***}$  & $5.37^{***}$  \\
...
Spline 2                & $-1.90^{***}$ & $-1.62^{***}$ & $-1.97$      & $2.20$       & $-1.31$       & $1.71$        \\
                        & $(0.43)$      & $(0.43)$      & $(1.57)$     & $(1.34)$     & $(1.62)$      & $(2.64)$      \\
...
{\centering \includegraphics[width=\maxwidth]{figures/Trade_Effect_Plot-1} 
...
{\centering \includegraphics[width=\maxwidth]{figures/Trade_Effect_Plot-2} 
...
{\centering \includegraphics[width=\maxwidth]{figures/BMA_Plot-1} 
...
{\centering \includegraphics[width=\maxwidth]{figures/BMA_Plot_Inclusions-1} 
...
{\centering \includegraphics[width=\maxwidth]{figures/Case_Studies_Plots-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{FALSE Error in eval(expr, envir, enclos): could not find function "{}stargazer"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in glm.control(robust = TRUE): unused argument (robust = TRUE)}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .stargazer.wrap(..., type = type, title = title, style = style, : object 'z.out.controls.no.trade.outliers' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in envRefInferField(x, what, getClass(class(x)), selfEnv): 'result' is not a valid field or method name for reference class "{}Zelig-ls"{}}}\end{kframe}
\clearpage
}
...
{\centering \includegraphics[width=\maxwidth]{figures/BMA_Plot_Supp-1} 
...
{\centering \includegraphics[width=\maxwidth]{figures/BMA_Plot_Supp_Inclusions-1} 
