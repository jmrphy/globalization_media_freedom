...
% Date and time: Sat, Apr 12, 2014 - 20:31:34
...
\\[-1.8ex] & (1) & (2) & (3)\\ 
\hline \\[-1.8ex] 
 Democracy level & 4.09$^{***}$ & 4.08$^{***}$ & 4.08$^{***}$ \\ 
  & (0.14) & (0.15) & (0.16) \\ 
  Democracy change & $-$0.23$^{***}$ & $-$0.24$^{***}$ & $-$0.24$^{***}$ \\ 
  & (0.08) & (0.08) & (0.08) \\ 
  GDP per capita & 1.34$^{***}$ & 0.97$^{***}$ & 0.92$^{***}$ \\ 
  & (0.12) & (0.15) & (0.21) \\ 
  GDP per capita change & 0.28$^{**}$ & 0.25$^{*}$ & 0.23$^{*}$ \\ 
  & (0.13) & (0.14) & (0.14) \\ 
  Interpolated & $-$0.07 & $-$0.11 & $-$0.12 \\ 
  & (0.23) & (0.23) & (0.23) \\ 
  Spline 1 & 1.64 & 2.46$^{**}$ & 2.52$^{**}$ \\ 
  & (1.18) & (1.19) & (1.20) \\ 
  Spline 2 & $-$2.48$^{**}$ & $-$3.60$^{***}$ & $-$3.60$^{***}$ \\ 
  & (1.19) & (1.22) & (1.22) \\ 
  Trade level &  & $-$0.32$^{***}$ & $-$0.33$^{***}$ \\ 
  &  & (0.12) & (0.12) \\ 
  Trade change &  & 0.02 & 0.04 \\ 
  &  & (0.14) & (0.14) \\ 
  FDI level &  & 0.68 & 0.53 \\ 
  &  & (0.42) & (0.44) \\ 
  FDI change &  & 0.33$^{**}$ & 0.37$^{**}$ \\ 
  &  & (0.15) & (0.15) \\ 
  FPI level &  & 1.05$^{***}$ & 1.03$^{***}$ \\ 
  &  & (0.18) & (0.18) \\ 
...
{\centering \includegraphics[width=\maxwidth]{figures/Trade_Effect_Plot} 
...
{\centering \includegraphics[width=\maxwidth]{figures/FDI_Effect_Plot} 
...
{\centering \includegraphics[width=\maxwidth]{figures/FPI_Effect_Plot} 
...
The baseline Model 1 already correctly predicts the state of media freedom in 3039 country-years. Model 3 correctly explains 12 additional cases, correctly classifying 3051.

\afterpage{

% Table created by stargazer v.4.5.3 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Sat, Apr 12, 2014 - 20:32:18
\begin{table}[!htbp] \centering 
  \caption{Cases Incorrectly Classified by Democracy and Domestic Economy but
...
{\centering \includegraphics[width=\maxwidth]{figures/Explained_Cases_Plots} 
...
Next, I turn to the brief case studies of Argentina and Mexico to assess qualitatively whether we can observe implications of trade liberalization generating pressures toward media repression.
